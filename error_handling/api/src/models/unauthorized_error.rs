...
impl UnauthorizedError {
    pub fn new(status: Option<serde_json::Value>, title: Option<serde_json::Value>, instance: Option<serde_json::Value>, detail: Option<serde_json::Value>) -> UnauthorizedError {
        UnauthorizedError {
            status,
            title,
            r#type: None,
