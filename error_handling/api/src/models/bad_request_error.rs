...
pub struct BadRequestError {
    ...
    pub invalid_parameters: Vec<models::InvalidParametersInner>,
}

impl BadRequestError {
    pub fn new(status: i32, title: String, instance: String, detail: String, invalid_parameters: Vec<models::InvalidParametersInner>) -> BadRequestError {
        BadRequestError {
            status,
            title,
            r#type: None,
